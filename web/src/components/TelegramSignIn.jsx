export default function TelegramSignIn() {
  return (
    <a
      ...
      className="w-full py-3 rounded-lg border border-brand-border bg-brand-surface text-brand-text font-medium hover:bg-brand-card transition-colors flex items-center justify-center gap-3 no-underline"
    >
