...
const CUSTOM_AVATARS = [
  // Realistic — batch 1
  { url: `${R2C}/03ebd213-a7b8-457b-ab70-bf8dcfd7db7f.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/ddb5c3c0-7df1-43ca-bd06-6a7c4c9c35a3.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/d7ede44e-5676-4672-868b-3704ca0399dd.jpg`, hair: 'red', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/a4d9024a-129b-4406-bed2-e00564612d4f.jpg`, hair: 'black', skin: 'asian', style: 'real', age: '20-22' },
  { url: `${R2C}/4d45d803-b90a-4bd4-a311-3028ffce54d0.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/91de6f92-5d82-4b1f-b99f-1f4ed51bdc6d.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '26-30' },
  { url: `${R2C}/d0159b29-ba4e-47cf-abbc-8d213854c915.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '20-22' },
  { url: `${R2C}/238e014a-fcb2-4ce7-8eee-7b67cb18e587.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '26-30' },
  { url: `${R2C}/05f74a7f-db7c-4151-aed0-c96dd90aca19.jpg`, hair: 'black', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/0de421d8-a44c-4148-9d20-d930ce08ae94.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/e2d0327f-c888-48d4-b73e-83b531dc3cd6.jpg`, hair: 'other', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/94b792fb-265f-4832-b374-411d2cbcc326.jpg`, hair: 'brunette', skin: 'dark', style: 'real', age: '26-30' },
  { url: `${R2C}/d635aa3f-38b5-4fa0-bfca-f14be668a252.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/5580f18d-0ead-403f-9e35-4e02ab3f04d6.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/7df9390d-4dd0-47b6-8303-34caa28612a7.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '26-30' },
  { url: `${R2C}/ebe3416f-71c4-4b88-9e22-85ad32dca153.jpg`, hair: 'black', skin: 'medium', style: 'real', age: '23-25' },
  { url: `${R2C}/c80ac2b1-135c-4e51-9ddb-c01f9d170bfd.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/42e57b22-83a0-46d9-a968-a3a472d8e9a3.jpg`, hair: 'black', skin: 'medium', style: 'real', age: '26-30' },
  { url: `${R2C}/79d337a2-85c6-4c3e-a73b-0dc0d46a20a5.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/bd068b08-3ce1-4065-a502-6a3132c91926.jpg`, hair: 'red', skin: 'light', style: 'real', age: '23-25' },
  // Realistic — batch 2 blonde
  { url: `${R2C}/3b9b72ea-aae7-46d0-b896-f286019f8d21.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/f4121b7c-7231-4ac8-8559-d076e8c30a91.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/05411fae-297f-4a22-8574-a96f59563fbf.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '26-30' },
  { url: `${R2C}/b151fb54-edc1-43fb-9694-a87e425410a0.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/aa1520b2-b727-432d-b6ad-749c3eb61a7d.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '23-25' },
  // Realistic — batch 2 brunette
  { url: `${R2C}/55a0c623-5552-46b9-af3c-47782c6bd0c4.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '26-30' },
  { url: `${R2C}/ab17ffa5-be42-4c9f-8f50-2a3be0c3664b.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/a4b12f77-3d2c-4363-ac32-1d56e46e6a12.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/cb8991af-4a6b-4e76-b89c-bdac8d4d9287.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/c8be6ef7-009f-48fe-87c2-0a99e96c14f1.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '26-30' },
  // Realistic — batch 2 black
  { url: `${R2C}/33bdc7e6-d0e2-4f4a-b415-eab3ae5d734b.jpg`, hair: 'black', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/6666fce3-8632-4031-9278-8b22fe76fea7.jpg`, hair: 'black', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/df44b709-61c6-4e48-a466-5afc439ce08d.jpg`, hair: 'black', skin: 'asian', style: 'real', age: '20-22' },
  { url: `${R2C}/cacb021b-0727-4db8-b6d5-18589ce1e447.jpg`, hair: 'black', skin: 'medium', style: 'real', age: '26-30' },
  { url: `${R2C}/a3e87986-9d4e-4e37-bc79-ecd39913d902.jpg`, hair: 'black', skin: 'medium', style: 'real', age: '23-25' },
  // Realistic — batch 2 red
  { url: `${R2C}/14b04dd1-2e0c-4b4e-9cb3-2c189b8ff9be.jpg`, hair: 'red', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/e3835dc6-2116-4d91-9178-4f79a18a4378.jpg`, hair: 'red', skin: 'light', style: 'real', age: '26-30' },
  { url: `${R2C}/8cc825e4-843b-4de7-b0ab-4f2acffcc006.jpg`, hair: 'red', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/b6f29a8d-27ca-43a4-bcb5-dfd5c8e92b9a.jpg`, hair: 'red', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/38490e1d-0cab-4d91-953c-9956f225b40a.jpg`, hair: 'red', skin: 'light', style: 'real', age: '26-30' },
  // Realistic — batch 2 other
  { url: `${R2C}/eb827240-5aad-4ff7-9824-4fcb2e0db2f3.jpg`, hair: 'other', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/09360191-090e-406b-913b-2c25ae11c4d1.jpg`, hair: 'other', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/d2c56ab0-f19f-4264-be70-35761acaf921.jpg`, hair: 'other', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/5e668591-5d1b-447c-83b8-1bdde3b3818a.jpg`, hair: 'other', skin: 'light', style: 'real', age: '26-30' },
  { url: `${R2C}/b6507bae-784d-41de-9260-0f5936f99918.jpg`, hair: 'other', skin: 'light', style: 'real', age: '23-25' },
  // Realistic — batch 2 diverse
  { url: `${R2C}/f93e8e55-020f-4b55-a07d-dda959bff1d6.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '26-30' },
  { url: `${R2C}/0c383558-e595-452a-8179-ecf6ed679404.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '23-25' },
  { url: `${R2C}/4e8068a8-e751-432d-b3d7-fd3c700005ec.jpg`, hair: 'black', skin: 'asian', style: 'real', age: '23-25' },
  { url: `${R2C}/29fa08c2-1985-4d2f-bd89-fa0ffc8e64ef.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '20-22' },
  { url: `${R2C}/eca98ad7-0c90-4c61-8674-23332f38782a.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '26-30' },
  // Realistic — batch 3
  { url: `${R2C}/32776e78-94ca-4236-9d98-06a2d6c40ce3.jpg`, hair: 'brunette', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/7e81de2d-1f50-41a3-8564-820e1d971da8.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/2ec7e41e-3a7b-44c5-be35-490b3eb8d1a4.jpg`, hair: 'red', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/1458535a-5eda-4a9b-885f-92f42abe519d.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '26-30' },
  { url: `${R2C}/0b01e9d3-9adb-4e7f-a8d9-fb26a37d79e2.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '23-25' },
  { url: `${R2C}/e58f1d3d-a3ca-4292-8618-369217523e5c.jpg`, hair: 'black', skin: 'medium', style: 'real', age: '20-22' },
  { url: `${R2C}/3ebf8d37-0b72-46b1-b0c5-1fbfcd229122.jpg`, hair: 'black', skin: 'dark', style: 'real', age: '23-25' },
  { url: `${R2C}/2b070d04-4532-41a0-ae80-2e451606aba5.jpg`, hair: 'black', skin: 'dark', style: 'real', age: '20-22' },
  { url: `${R2C}/12d5107e-dfbf-458a-a3c2-ebd88565481a.jpg`, hair: 'black', skin: 'dark', style: 'real', age: '26-30' },
  // Realistic — batch 4
  { url: `${R2C}/aa9dd6ae-2647-4e21-af11-dc9401391489.jpg`, hair: 'black', skin: 'light', style: 'real', age: '23-25' },
  { url: `${R2C}/b5130012-835e-4373-a74f-05c8beb5bc0d.jpg`, hair: 'blonde', skin: 'light', style: 'real', age: '20-22' },
  { url: `${R2C}/60142c55-d9ae-4d08-8d6e-d69c5010f85e.jpg`, hair: 'black', skin: 'dark', style: 'real', age: '26-30' },
  { url: `${R2C}/45d282b0-2f86-4a85-bf83-a50e214e128d.jpg`, hair: 'brunette', skin: 'medium', style: 'real', age: '23-25' },
  { url: `${R2C}/5e475f9b-ca82-49bf-98ef-cc1b794444ff.jpg`, hair: 'black', skin: 'asian', style: 'real', age: '20-22' },
  // Anime — young (20-22)
  { url: `${R2A}/0e6e3437-cf31-454a-a3b0-1fba8e72e3b2.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '20-22' },
  { url: `${R2A}/0830f45e-9a2c-404a-857a-93b7fb8e2f60.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '20-22' },
  { url: `${R2A}/ad94b84a-84ac-4b5b-a2e7-4e2f9e9e3a10.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '20-22' },
  { url: `${R2A}/7de9fad2-4e73-4dbe-afc0-91bddabc5f38.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '20-22' },
  { url: `${R2A}/f3f9e410-e53e-488b-a3a2-d9e45157bdf3.jpg`, hair: 'blonde', skin: 'light', style: 'anime', age: '20-22' },
  // Anime — mid (23-25)
  { url: `${R2A}/8808f882-9036-47a2-93ce-b7f9caf414df.jpg`, hair: 'black', skin: 'asian', style: 'anime', age: '23-25' },
  { url: `${R2A}/f65a5836-622b-4d8a-8eb6-3ebd3e629974.jpg`, hair: 'brunette', skin: 'light', style: 'anime', age: '23-25' },
  { url: `${R2A}/13a65968-4e10-479a-8528-44f2ba8997dc.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '23-25' },
  { url: `${R2A}/107ced67-d06d-49a7-b74d-c28a9d8bf8d0.jpg`, hair: 'red', skin: 'light', style: 'anime', age: '23-25' },
  { url: `${R2A}/77a06d69-70fc-4fec-9970-0ffda0938e21.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '23-25' },
  // Anime — mature (26-30)
  { url: `${R2A}/faa5f7da-fbc4-4e57-9d1d-8a6f261ab747.jpg`, hair: 'black', skin: 'light', style: 'anime', age: '26-30' },
  { url: `${R2A}/94dfb7b2-0050-4e48-a9b7-8fdf6b3a9628.jpg`, hair: 'red', skin: 'light', style: 'anime', age: '26-30' },
  { url: `${R2A}/6eca50ae-a125-4309-816c-d799794d8843.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '26-30' },
  { url: `${R2A}/e7ab31ca-6cea-4db6-9b2c-af630831a078.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '26-30' },
  { url: `${R2A}/d95f066b-dc4d-443b-99b0-ce614b8839f0.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '26-30' },
  // Anime — mixed
  { url: `${R2A}/f3acc5f3-a839-401e-8faf-fdca12f9f93d.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '20-22' },
  { url: `${R2A}/7b46fac6-9872-471d-9b4f-0ee6b6c05c89.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '23-25' },
  { url: `${R2A}/700b4223-43d0-4c56-b85b-110c859316f8.jpg`, hair: 'blonde', skin: 'light', style: 'anime', age: '20-22' },
  { url: `${R2A}/e33f2af8-6c60-4160-b72e-b81da64c8063.jpg`, hair: 'red', skin: 'light', style: 'anime', age: '26-30' },
  { url: `${R2A}/46365b8f-c41e-4e15-8e6f-03cc452b30fe.jpg`, hair: 'other', skin: 'light', style: 'anime', age: '23-25' },
];
...
const AGE_FILTERS = [
  { key: 'all', label: 'All' },
  { key: '20-22', label: '20-22' },
  { key: '23-25', label: '23-25' },
  ...
  async function createCompanion() {
    ...
    try {
      const body = selected.isTemplate
        ...
        : { name: selected.name, personality: selected.personality, avatarUrl: selected.avatar_url };
