...
const MIGRATIONS = [
  {
    ...
    sql: `
      ...
      INSERT INTO app_settings (key, value) VALUES
        ...
        ('memory_extraction_model', '"google/gemini-2.0-flash-001"')
  ...
  },
  {
    ...
    sql: `INSERT INTO app_settings (key, value) VALUES ('memory_extraction_model', '"google/gemini-2.0-flash-001"') ON CONFLICT (key) DO NOTHING`,
  },
];
